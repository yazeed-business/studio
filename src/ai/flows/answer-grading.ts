...
const AnswerGradingOutputSchema = z.object({
  ...
  passed: z.boolean().describe('Whether the answer met the passing criteria (e.g., score >= 70).'),
});
...
Consider a passing score to be 70 or above and set the 'passed' field accordingly.
